...
RESULT_ROOT="${RESULT_ROOT:-benchmark_results/phase4c_pace}"
...
run_experiment p4c_pace_ref \
  --ent-coef 0.01 \
  --early-reward-horizon 200 \
  --early-progress-weight 40.0

run_experiment p4c_pace_progress60 \
  --ent-coef 0.01 \
  --early-reward-horizon 300 \
  --early-progress-weight 60.0

run_experiment p4c_pace_progress80 \
  --ent-coef 0.01 \
  --early-reward-horizon 300 \
  --early-progress-weight 80.0

run_experiment p4c_pace_progress60_sustain \
  --ent-coef 0.0075 \
